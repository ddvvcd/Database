...
INSERT INTO `Students` VALUES ('20101001', 10, 'P10101', '정우성', '760121-1234567', '010-1101-7601', ' ', '서울');
INSERT INTO `Students` VALUES ('20101002', 10, 'P10101', '이정재', '750611-1234567', '010-1102-7506', ' ', '서울');
...
#문제4 (모든 강좌의 강좌번호, 강좌명, 담당교수번호, 담당교수명, 휴대폰, 학과번호, 학과명을 조회하시오)
SELECT `lecNo`,
		 `lecName`,
		 b.proNo,
		 `proName`,
...
#문제6 (수강신청 테이블에 출석점수, 중간고사점수, 기말고사 점수를 임의로 입력하시오(1~100사이))
